...
<body onload='editarPeliculaDetalle(<?php echo '"'.$_GET['id'].'"'; ?>), listas()' >
      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
            ...
            <div class="form-group">
              ...
              <div class="input-group ">
                  <div class="input-group-prepend">
                   ...
                   <input type="text" class="form-control input-lg" value="" id="editarCodigo" placeholder="Ingresar codigo" required="" readonly="">
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group ">
                  <div class="input-group-prepend">
                   ...
                   <input type="text" class="form-control input-lg" value="" id="editarNombre" placeholder="Ingresar nombre" required="">
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group ">
                  <div class="input-group-prepend">
                   ...
                   <input type="text" class="form-control input-lg" value="" id="editarGenero" placeholder="Ingresar genero" required="">
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group ">
                  <div class="input-group-prepend">
                   ...
                   <input type="text" class="form-control input-lg" value="" id="editarDescripcion" placeholder="Ingresar descripcion" required="">
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group ">
                  <div class="input-group-prepend">
                   ...
                   <input type="text" class="form-control input-lg" value="" id="editarAnio" placeholder="Ingresar año de lanzamiento" required="">
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group ">
                  <div class="input-group-prepend">
                   ...
                   <input type="text" class="form-control input-lg" value="" id="editarUbicacion" placeholder="Ingresar ubicacion" required="">
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group ">
                  <div class="input-group-prepend">
                   ...
                   <input type="text" class="form-control input-lg" value="" id="editarPoster" placeholder="Ingresar url del poster" required="">
              </div>
            </div>
          </div>
          <br><br><br>
          ...
          <div class="text-center">
            ...
            <button onclick='editarPelicula(<?php echo '"'.$_GET['id'].'"'; ?>);' class="btn btn-lg " style="background:#27a776"> Editar Pelicula</button>
